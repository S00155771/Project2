...
const String CLIENT_ID = "969998500214-nd3d8a29e3cu2ble8mjocobcq9eueaca.apps.googleusercontent.com";

// the clientSecret found in Google's Developer Console under API Manager > Credentials
const String CLIENT_SECRET = "vwUXYbDzE-mqwxqe7nBOW0V-";

// returned after running FinalizeOAuth
const String REFRESH_TOKEN = "1/HvAMm0MYfHgTOXGsFG2P1cLxKCLB-t6DKGQs32r__mQ";
...
String myName = "Gavin Little 27 April"; //Enter your name here
...
//    int sensorValue = ;
    ...
    String rowData = "[[\"" + String(now) + "\", \"" + int(sensorReading) + "\", \"" + (myName) + "\"]]";
